...
function TrainerPosts(props) {
  ...
  function handlePostClick() {
    document.getElementById(`postSubmit-${props.batch_id}`).style.display =
      "block";
    document.getElementById(`postList-${props.batch_id}`).style.display =
      "none";
  }
  ...
  function handleFormSubmit(e) {
    ...
    formData.append("batch", props.batch_id);
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  id={"fileInput-" + props.batch_id}
                  name="file"
                  onChange={(e) =>
                    file.setValue(
                      document.getElementById(`fileInput-${props.batch_id}`)
                        .files[0]
                    )
                  }
                />
