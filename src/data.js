...
export const developers_Details = [
  {
    id: 1,
    src: require("./images/jagadeeshsir.jpg").default,
    name: "Mr. Jagadeesh Gajula",
    degree:
      "BCA, PGD (AIML), MSc (AIML) - Liver Poole John Moores University, London.",
    contribution: "Website Building Coordinator.",
    link: "https://www.linkedin.com/in/jagadeeshgajula1",
  },
  {
    id: 2,
    src: require("./images/ashok.jpeg").default,
    name: "Mr. Ashok Babu",
    degree:
      "B.Tech 3rd year, CSE, SRKR Engineering College, Bhimavaram, Andhra Pradhesh.",
    contribution: "Backend Team Leader",
    link: "https://www.linkedin.com/in/ashok-babu-g-5220971a5",
  },
  {
    id: 3,
    src: require("./images/nitesh.jpeg").default,
    ...
    contribution: "Frontend Team Leader",
    link: "https://www.linkedin.com/in/nitesh-kumar-5ab3691b8",
  },
  {
    id: 4,
    src: require("./images/naman.jpeg").default,
    name: "Mr. Naman Garg",
    degree:
      "BCA 2nd year, Kamal Institute of Higher Education and Advance Technology, New Delhi, India.",
    contribution: "Backend Team Member",
    link: "https://www.linkedin.com/in/naman-garg-935658201",
  },
  {
    id: 5,
    src: require("./images/amit.jpeg").default,
    name: "Mr. Amit",
    degree: "MCA 2nd year, Lovely Professional University, Amritser, Punjab.",
    contribution: "Frontend Team Member",
    link: "https://www.linkedin.com/in/amit-kumar-bharti-76b811208",
  },
  {
    id: 6,
    src: require("./images/praneeth.jpg").default,
    name: "Mr. Praneeth Kumar Ketha",
    degree:
      "B.Tech 3rd year CSE, Sri Venkateswara College of Engineering, Tirupati, Andhra Pradesh.",
    contribution: "Website Beautician",
    link: "https://www.linkedin.com/in/praneeth-kumar-2717231a1",
  },
  {
    id: 7,
    src: require("./images/vidhushi.jpeg").default,
    name: "Ms. Vidushi Agarwal",
    degree:
      "B.Tech 3rd year CSE, Dehradun Institute of Technology, Varanasi Tehsil, Uttar Pradesh. ",
    contribution: "Frontend Team Member",
    link: "https://www.linkedin.com/in/vidushi-agrawal-0631721b6",
  },
];
...
export const motive = [
  ...
  {
    id: 2,
    src: require("./images/home-2.jpg").default,
    title: "Vision Of SURE Initiative",
    content: `“SURE” Initiative's vision is to address this challenge by enhancing the employability of educated unemployed youth, particularly living in rural areas,   through ‘Human values-based’ skill up-gradation in emerging technologies, with no cost to students.`,
  },
  {
    id: 3,
  ...
  {
    id: 4,
    src: require("./images/home-4.jpg").default,
    title: "What does SURE INITIATIVE DO",
    content:
      "Makes effort to bridge the gap between the skills acquired from the academic institutions and the skills required in the industry for employing them.",
  },
  {
    id: 5,
    src: require("./images/home-5.jpg").default,
    title: "A unique intellectual & sustainable “grama-seva” initiative",
    content:
      "Quality training for Skill upgradation is paramount in a technology dominated world. Rural youth misses out on majority of the initiatives due to remoteness. Hence, urgent need to bring the educated unemployed rural youth into the main stream. The training which is in online mode takes the access across India.",
  },
  {
    id: 6,
    src: require("./images/home-6.jpg").default,
    title: "Initiated and Managed by SSSIHL Alumni and Sai Devotees",
    content:
      " SURE team believes that the strategy adopted is one of the ways to address the challenge of enhancing the skills of growing educated rural work force.",
  },
];
